...
public class ClubDeptCategoryVO {
	...
	public ClubDeptCategoryVO() {
		super();
	}
	public ClubDeptCategoryVO(int club_category_no, String club_category_name, String club_category_description,
			String club_dept_image_link, String club_category_state) {
		super();
