...
public interface ClubBoardSQLMapper {
	// 특정 클럽의 자유게시판 전체 리스트 가져오기
		public ArrayList<Club_BoardVO> selectClubBoardListByClubNo(@Param(value = "clubNo") int clubNo,
		...
		public Club_BoardVO[] selectClubBoardListForContentPageByClubNo(int clubNo);
		...
		// 댓글 리스트 가져오기
		public ArrayList<Club_BoardCommentVO> selectClubBoardCommentList_ByClubNoAndClubBoardNo(@Param(value="clubBoardNo")int clubBoardNo,@Param(value="clubNo") int clubNo); 
		// 댓글 삭제																						 
