                  	...
                  	<!-- 컨텐트 헤더 -->
                  		<div class="row">
			         			<div class="col" style="margin-top:0.8em">
			         				<i class="fa bi bi-search mr-3 text-primary fa-fw" style="width:2em; height:1.2em"></i>&nbsp <span class="page_title">동아리 찾기</span>
			         			</div>
			         		</div>
										...
										<div class="col my-3">
											<div class="row">
												...
												<div class="col my-2">
													...
													<div class="row pt-4">
														<div class="col-4"></div>
														<div class="col category_box_content">안녕하세요 저는
															안요섭입니다.</div>
													</div>
													<div class="row mt-4">
														<div class="col-4"></div>
														<div class="col">
															...
															<button class="btn btn-primary"><a href="./student_clubsOfCategoryPage?club_category_no=1" style="color:white;">자세히보기</a></button>
														</div>
													</div>
												</div>
											</div>
										...
										<div class="col my-3">
											<div class="row">
												...
												<div class="col my-2">
													...
													<div class="row pt-4">
														<div class="col-4"></div>
														<div class="col category_box_content">안녕</div>
													</div>
													<div class="row mt-4">
													<div class="col-4"></div>
														<div class="col">
															...
															<button class="btn btn-primary"><a href="./student_clubsOfCategoryPage?club_category_no=2" style="color:white;">자세히보기</a></button>	
														</div>
													</div>
												</div>
											</div>
												...
												<div class="col my-2">
													...
													<div class="row mt-4">
														...
														<div class="col">
															...
															<button class="btn btn-primary"><a href="./student_clubsOfCategoryPage?club_category_no=3" style="color:white;">자세히보기</a></button>	
														</div>
													</div>
												</div>
											</div>
												...
												<div class="col my-2">
													...
													<div class="row mt-4">
														...
														<div class="col">
															...
															<button class="btn btn-primary"><a href="./student_clubsOfCategoryPage?club_category_no=4" style="color:white;">자세히보기</a></button>	
														</div>
													</div>
												</div>
											</div>
												...
												<div class="col my-2">
													...
													<div class="row mt-4">
														...
														<div class="col">
															...
															<button class="btn btn-primary"><a href="./student_clubsOfCategoryPage?club_category_no=5" style="color:white;">자세히보기</a></button>	
														</div>
													</div>
												</div>
											</div>
												...
												<div class="col my-2">
													...
													<div class="row mt-4">
														...
														<div class="col">
															...
															<button class="btn btn-primary"><a href="./student_clubsOfCategoryPage?club_category_no=6" style="color:white;">자세히보기</a></button>	
														</div>
													</div>
												</div>
											</div>
												...
												<div class="col my-2">
													...
													<div class="row mt-4">
														...
														<div class="col">
															...
															<button class="btn btn-primary"><a href="./student_clubsOfCategoryPage?club_category_no=7" style="color:white;">자세히보기</a></button>	
														</div>
													</div>
												</div>
											</div>
