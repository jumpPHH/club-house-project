...
<jsp:include
	...
	<div class="page-content p-5" id="content">
		...
		<div class="row border-bottom" style="padding-top: 10px; padding-bottom: 10px; text-align: center;">
			...
			<div class="col"><a href="/cbh/student/myclubactivity/student_MyClubActivityReadPage">제목제목제목제목</a></div>
			<div class="col-1">김자바</div>
			<div class="col-1">220406</div>
			<div class="col-1">666</div>
		</div>
		...
		<nav aria-label="Page navigation example">
		  <ul class="pagination">
		    ...
		    <li class="page-item"><a class="page-link" href="#">&gt;&gt;</a></li>
				...
				<!-- 여기다 작성하세요 -->
				<a href="./student_MyClubActivityWritePage" class="btn btn-primary">글쓰기</a>
			</div>
			<div class="col-1"></div>
		</div>
