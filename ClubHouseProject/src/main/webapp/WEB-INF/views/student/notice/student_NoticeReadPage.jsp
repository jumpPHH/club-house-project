...
<jsp:include
	...
	<div class="row border-bottom border-dark" style="padding-top: 10px; padding-bottom: 10px;">
		<div class="col-6">${noticeData.noti_title }</div>
		<div class="col">작성일 <fmt:formatDate value="${noticeData.noti_date}" pattern="yy.MM.dd"/></div>
		<div class="col">조회수 ${noticeData.noti_readcount}</div>
	</div>
	<span 
