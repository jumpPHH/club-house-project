					...
					<div class="col" id="content">
							...
							<div class="row my-5 py-5">
								<div class="col text_align_center font_bold">
									<h1>동아리 정보 입력이 완료되었습니다.<br>동아리 페이지 이용이 가능합니다!</h1>
								</div>
							</div>
							<div class="row">
								<div class="col text_align_center">
									<button type="button" class="btn btn-danger" style="width:40em; height:3em;" onclick="location.href='#'">동아리 메인 페이지로 이동</button>
								</div>
							</div>
