			...
			<div class="col">
				...
				<div class="row">
					<div class="col" id="content">
							...
							<!-- 신청서 양식 시작 -->
							<form action="./writeClubInfoProcess" enctype="multipart/form-data" method="post">
							<div class="row px-4 mt-2" style="border: 1px solid #e2dede; border-radius:5px;">
								<div class="col" >
									...
									<div class="row p-3" >
										...
										<div class="col">
											<select class="custom-select my-1 mr-sm-2 form-control" id="inlineFormCustomSelectPref" name="club_category_no">
									...
									<div class="row p-3">
										...
										<div class="col">
											<div class="row">
												<div class="col text_align_left mt-2">
													<textarea class="form-control" style="height:15vh" name="club_description"></textarea>
												</div>
											</div>
										</div>
									</div>
										...
										<div class="col">
											<div class="row">
												<div class="col text_align_right mt-2">
													<span style="color:red">이미지는 하나만 첨부 가능합니다</span> 
													<input type="file" name="dscrp_image">
												</div>
											</div>
										</div>
									</div>
